      ...
      <div className="max-w-[600px] mx-auto px-5 py-6">
        ...
        <section className="mb-8">
          ...
          <div className="space-y-3">
            {[
              { company: "University of California Merced", role: "Research Assistant", date: "May 2026 – Aug 2026", img: "/UC_Merced_Seal.png" },
              ...
              { company: "Accumine Technologies", role: "Software Engineering Intern", date: "Jun 2023 – Aug 2023", img: "/accuminetech-Photoroom.png" },
            ].map((exp) => (
